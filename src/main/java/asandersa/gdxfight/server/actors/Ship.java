package asandersa.gdxfight.server.actors;

import com.badlogic.gdx.utils.Json;
import com.badlogic.gdx.utils.JsonValue;

public class Ship implements Json.Serializable {
    private String id;
    private float angle;
    private float x;
    private float y;
    ...
    public void act(float delta) { //delta - количество мс с прошедшего кадра
